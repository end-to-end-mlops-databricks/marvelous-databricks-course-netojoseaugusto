...
mlflow.set_experiment(experiment_name="/Shared/loans-prediction-basic")
mlflow.set_experiment_tags({"repository_name": "loans-prediction"})
...
run_id = mlflow.search_runs(
    experiment_names=["/Shared/loans-prediction-basic"],
